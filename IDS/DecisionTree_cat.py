'''
Actual training data 1L records
----> Observed training records 83K <----
Check maybe training and testing swaped



TRAINING DATA DECISION TREE CHECKED
'''
...
print("Time to training_data:")
print(end-start)
print("Time to predict:")
print(end1-start1)
# f_predictions.show(3)
print("\n \t\t\tLabel indexing by model\n")
df_yog.stat.crosstab('Pred_Label','attack_cat').show()
